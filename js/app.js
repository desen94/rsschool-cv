...
if (location.hash) {
    ...
    if (document.querySelector('div.' + hsh)) {
...
window.onscroll = () => {
    ...
    sections.forEach((el) => {
        ...
        if (scroll > top && scroll < bottom) {
            const activeLink = document.querySelector('a._active')
            const currentLink = document.querySelector(`a[href="#${el.id}"]`)
            activeLink && activeLink.classList.remove('_active')
            currentLink && currentLink.classList.add('_active')
        }
    ...
    if (contacts && scrollHeight - clientHeight === window.scrollY) {
